// scripts/uscis_check.js
// Consulta la cola en tu Laravel, visita USCIS con Playwright y reporta el HTML a tu API.
...
(async () => {
  ...
  for (const it of items) {
    ...
    try {
      ...
      await page.close();
      await sleep(900 + Math.random()*1300); // rate-limit entre casos
    }
  }
